...
- (void) drawDragViews {
    ...
    //DragView 1
    self.topLeftItem = [[DragView alloc] initWithFrame:CGRectMake(26.0, 165.0, 70.0, 70.0) andNbImages:25 andPath:@"round_emotion_01_%d.png" andColor:color1];
    self.topLeftItem.tag = 1;
    self.topLeftItem.value = @"Nez";
    [self.view addSubview:self.topLeftItem];
    
    //DragView 2
    self.topRightItem = [[DragView alloc] initWithFrame:CGRectMake(227.0, 165.0, 70.0, 70.0) andNbImages:25 andPath:@"round_emotion_02_%d.png" andColor:color2];
    self.topRightItem.tag = 2;
    self.topRightItem.value = @"Fesses";
    [self.view addSubview:self.topRightItem];
    
    //DragView 3
    self.bottomRightItem = [[DragView alloc] initWithFrame:CGRectMake(227.0, 455.0, 70.0, 70.0) andNbImages:25 andPath:@"round_emotion_03_%d.png" andColor:color3];
    self.bottomRightItem.tag = 3;
    self.bottomRightItem.value = @"Dos";
    [self.view addSubview:self.bottomRightItem];
    
    //DragView 4
    self.bottomLeftItem = [[DragView alloc] initWithFrame:CGRectMake(26.0, 455.0, 70.0, 70.0) andNbImages:25 andPath:@"round_emotion_04_%d.png" andColor:color4];
    self.bottomLeftItem.tag = 4;
    self.bottomLeftItem.value = @"Joues";
