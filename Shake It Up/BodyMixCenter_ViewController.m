...
- (void) drawDragViews {
    ...
    //DragView 2
    self.topRightItem = [[DragView alloc] initWithFrame:CGRectMake(227.0, 165.0, 70.0, 70.0) andNbImages:25 andPath:@"round_corps_02" andColor:color2];
    self.topRightItem.tag = 2;
    self.topRightItem.value = @"Visage";
    [self.view addSubview:self.topRightItem];
    
    //DragView 3
    self.bottomRightItem = [[DragView alloc] initWithFrame:CGRectMake(227.0, 455.0, 70.0, 70.0) andNbImages:25 andPath:@"round_corps_03" andColor:color3];
    self.bottomRightItem.tag = 3;
    self.bottomRightItem.value = @"Yeux";
    [self.view addSubview:self.bottomRightItem];
    
    //DragView 4
    self.bottomLeftItem = [[DragView alloc] initWithFrame:CGRectMake(26.0, 455.0, 70.0, 70.0) andNbImages:25 andPath:@"round_corps_04" andColor:color4];
